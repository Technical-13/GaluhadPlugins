	...
	[1] =
	{
		["SHREWLEISURELY"] =
		{
			["STRING"] =
			{
				...
				["RUSSIAN"] = "Drive away 10 pesky shrews\nCan be completed across numerous rounds";
			};
		...
		["SHREWPRACTICED"] =
		{
			["STRING"] =
			{
				...
				["RUSSIAN"] = "Drive away 10 pesky shrews before the end of the round";
			};
		...
		["SHREWELITE"] =
		{
			["STRING"] =
			{
				...
				["RUSSIAN"] = "Before the end of the round:\n\n1) Drive away 10 pesky shrews\n2) Plant 5 seedlings in mounds of soil";
			};
		...
		["SHREWENORMOUS"] =
		{
			["STRING"] =
			{
				...
				["RUSSIAN"] = "Drive away the enormous shrew";
			};
		...
		["FISTFULFLOWERS"] =
		{
			["STRING"] =
			{
				...
				["RUSSIAN"] = "Collect as many flowers as you can in one hour.\n\n<rgb=#ffc000>Marigolds</rgb> can be found north of Michel Delving\n<rgb=#f06ee0>Violets</rgb> can be found west of Bree\n<rgb=#bbfffb>Primroses</rgb> can be found west of Celondim\n\nThese are found in patches of flowers";
			};
		};
	};
	...
	[2] =
		...
		["TOOMUCHFESTIVAL"] =
		{
			["STRING"] =
			{
				...
				["GERMAN"] = "Find all 5 of Foxglove's items. They can all be found about the festival area.\n\nTeapot - 29.7s, 71.5w \nParasol - 30.2s, 71.5w \nWine - 29.9s, 71.1w \nBook - 29.7s, 71.2w \nTwine - 29.9s, 71.5w \n";
				["RUSSIAN"] = "Find all 5 of Foxglove's items. They can all be found about the festival area.\n\nTeapot - 29.7s, 71.5w \nParasol - 30.2s, 71.5w \nWine - 29.9s, 71.1w \nBook - 29.7s, 71.2w \nTwine - 29.9s, 71.5w \n";
			};
		};
		...
		["GOINGHUNGRY"] =
		{
			["STRING"] =
			{
				...
				["GERMAN"] = "Find all 5 of Melilot's items.\n\nPorridge - 29.4s, 71.4w \nCheese - 29.7s, 72.0w \nBread - 30.9s, 71.2w \nEggs - 30.4s, 71.4w \nMushrooms - 29.4s, 70.5w \n";
				["RUSSIAN"] = "Find all 5 of Melilot's items.\n\nPorridge - 29.4s, 71.4w \nCheese - 29.7s, 72.0w \nBread - 30.9s, 71.2w \nEggs - 30.4s, 71.4w \nMushrooms - 29.4s, 70.5w \n";
			};
		};
		...
		["BELONGINGS"] =
		{
			["STRING"] =
			{
				...
				["GERMAN"] = "Find all 5 of Mosco's items.\n\nLucky Bait - 30.5s, 70.1w \nFishing Pole - 31.3s, 69.9w \nHoe - 31.0s, 70.0w \nCloak - 31.3s, 69.2w \nElevenses Meal - 30.7s, 69.6w \n";
				["RUSSIAN"] = "Find all 5 of Mosco's items.\n\nLucky Bait - 30.5s, 70.1w \nFishing Pole - 31.3s, 69.9w \nHoe - 31.0s, 70.0w \nCloak - 31.3s, 69.2w \nElevenses Meal - 30.7s, 69.6w \n";
			};
		};
		...
		["STOCKINGPOND"] =
		{
			["STRING"] =
			{
				...
				["GERMAN"] = "1) The best place to catch amberjacks is inside Thorin's Hall near the waterfall.\n\n2) The best place to catch luillim is in Celondim by the docks.\n\n3) The best place to catch drum is near Bree, at the pond by Pierson's Farm (33.0s, 49.8w).";
				["RUSSIAN"] = "1) The best place to catch amberjacks is inside Thorin's Hall near the waterfall.\n\n2) The best place to catch luillim is in Celondim by the docks.\n\n3) The best place to catch drum is near Bree, at the pond by Pierson's Farm (33.0s, 49.8w).";
			};
		};
		...
		["FORGOTTENERRANDS"] =
		{
			["STRING"] =
			{
				...
				["GERMAN"] = "Find all 5 of Ambi's items.\n\nRed Jar - auction room by Farmann \nGreen Jar - vault by Escrow Broker Tuki \nBlue Bottle - main hall by minstrel trainer \nNote - eastern slope to the tavern \nPack - next to the bridge by the waterfall";
				["RUSSIAN"] = "Find all 5 of Ambi's items.\n\nRed Jar - auction room by Farmann \nGreen Jar - vault by Escrow Broker Tuki \nBlue Bottle - main hall by minstrel trainer \nNote - eastern slope to the tavern \nPack - next to the bridge by the waterfall";
			};
		};
		...
		["WAGER"] =
		{
			["STRING"] =
			{
				...
				["GERMAN"] = "Find all 5 of Skalli's items.\n\nThe items are all easily found within the race arena.";
				["RUSSIAN"] = "Find all 5 of Skalli's items.\n\nThe items are all easily found within the race arena.";
			};
		};
		...
		["MISSINGTHINGS"] =
		{
			["STRING"] =
			{
				...
				["GERMAN"] = "Find all 5 of Lalfor's items about Duillon.\n\nGoblet - 24.1s, 93.2w \nJewellery Box - 23.9s, 93.0w \nBlue Book - 23.8s, 92.9w \nBrown Book - 23.8s, 92.7w \nBundle of Books - 23.9s, 92.7w \n";
				["RUSSIAN"] = "Find all 5 of Lalfor's items about Duillon.\n\nGoblet - 24.1s, 93.2w \nJewellery Box - 23.9s, 93.0w \nBlue Book - 23.8s, 92.9w \nBrown Book - 23.8s, 92.7w \nBundle of Books - 23.9s, 92.7w \n";
			};
		};
	...
	[3]=
		...
		["TROVESDUILLOND"] =
			...
			["EMOTES"] =
				...
				["GERMAN"] = {"/look","/hail","/eat","/dance"};
				["RUSSIAN"] = {"/look","/hail","/eat","/dance"};
				};
			};
		...
		["TROVESTHORINS"] =
			...
			["STRING"] =
				...
				["RUSSIAN"] = "Troves and Trickery -- Thorin's Hall \n\nPerform emotes on selected targets: \nLabourer in corridor near tavern = /whistle \nDwarf in Maker's Hall = /drink \nDwarf in Forging Hall = /flex \nDwarf in Main Hall by Hunter Trainer = /mock \n\nLocations and emotes from http://casualstrolltomordor.com";
				};
			["EMOTES"] =
				{
				["ENGLISH"] = {"/whistle","/drink","/flex","/mock"};
				["FRENCH"] = {"/siffler","/boire","/biceps","/railler"};
				["GERMAN"] = {"/whistle","/drink","/flex","/mock"};
				["RUSSIAN"] = {"/whistle","/drink","/flex","/mock"};
				};
			};
		...
		["TROVESSHIRE"] =
			...
			["STRING"] =
				...
				["RUSSIAN"] = "Troves and Trickery -- the Shire \n\nPerform emotes on selected targets: \n30.7S, 71.1W = /shiver \n31.0S, 70.9W = /tantrum \n31.5S, 71.4W = /burp \n29.5S, 71.2W = /pick \n\nLocations and emotes from http://casualstrolltomordor.com";
				};
			["EMOTES"] =
				{
				["ENGLISH"] = {"/shiver","/tantrum","/burp","/pick"};
				["FRENCH"] = {"/frissonner","/caprice","/rot","/démanger"};
				["GERMAN"] = {"/shiver","/tantrum","/burp","/pick"};
				["RUSSIAN"] = {"/shiver","/tantrum","/burp","/pick"};
				};
			};
		...
		["TROVESBREE"] =
			...
			["STRING"] =
				...
				["RUSSIAN"] = "Troves and Trickery -- Bree \n\nPerform emotes on selected targets: \n30.6S, 52.0W = /scold \n30.9S, 52.6W = /crazy \n31.9S, 50.6W = /no \n29.9S, 51.3W = /whippitydo \n\nLocations and emotes from http://casualstrolltomordor.com";
				};
			["EMOTES"] =
				{
				["ENGLISH"] = {"/scold","/crazy","/no","/whippitydo"};
				["FRENCH"] = {"/gronder","/fou","/non","/youpi"};
				["GERMAN"] = {"/scold","/crazy","/no","/whippitydo"};
				["RUSSIAN"] = {"/scold","/crazy","/no","/whippitydo"};
				};
			};
		...
		["RIDDLEBOTTLE"] =
			...
			["STRING"] =
				{
				["ENGLISH"] = "A Riddle in a Bottle \n\nWhite Botte - Riddle one answer is 'Tree' \nBlue Bottle - Riddle two answer is 'bee' \nOrange Bottle - Riddle three answer is 'paper' \nBlue Bottle - Blue is the second bottle you drank from.";
				["FRENCH"] = "Une \195\169nigme dans une bouteille \n\nBouteille blanche - R\195\169ponse \195\169nigme 1 'arbre' \nBouteille bleu - R\195\169ponse \195\169nigme 2 'abeille' \nBouteille orange - R\195\169ponse \195\169nigme 3 'papier' \nBouteille bleu - La bleu est la seconde bouteille que vous avez bu.";
				["GERMAN"] = "A Riddle in a Bottle \n\nWhite Botte - Riddle one answer is 'Tree' \nBlue Bottle - Riddle two answer is 'bee' \nOrange Bottle - Riddle three answer is 'paper' \nBlue Bottle - Blue is the second bottle you drank from.";
				["RUSSIAN"] = "A Riddle in a Bottle \n\nWhite Botte - Riddle one answer is 'Tree' \nBlue Bottle - Riddle two answer is 'bee' \nOrange Bottle - Riddle three answer is 'paper' \nBlue Bottle - Blue is the second bottle you drank from.";
				};
			};
		};
	...
	[4] =
		...
		["SNOWBEASTS"] =
			...
			["STRING"] =
				...
				["RUSSIAN"] = {"<rgb=#FF0000>/cheer</rgb> at snowbeasts (select target).\n\nThe snowbeasts can be found in the lightly wooded area in the southeast corner of the map (12.2N, 93.6W). - casualstrolltomordor.com"};
				};
			["EMOTES"] =
				{
				["ENGLISH"] = {"/cheer"};
		...
		["THEATRE"] =
			...
			["STRING"] =
				...
				["RUSSIAN"] = "Whilst in the theatre, why not enjoy a special performance of the Curious Disappearance of Mad Baggins.\n\nMake sure you stock up on rotten fruit and flower petals before the performance to use when the actors perform.";
				};
			["QUICKSLOTS"] =
				{
				["ENGLISH"] =
		...
		["VILLAIN"] = -- Gandalf
			...
			["STRING"] =
				...
				["RUSSIAN"] = "Perform emotes when prompted - note you must have selected <rgb=#FF0000>'The Audience'</rgb> as your target";
				};
			["EMOTES"] =
				{
				["ENGLISH"] = {"/laugh","/shakefist","/rude"};
				["FRENCH"] = {"/rire","/poing","/ricaner"};
				["GERMAN"] = {"/laugh","/shakefist","/rude"};
				["RUSSIAN"] = {"/laugh","/shakefist","/rude"};
				};
			["QUICKSLOTS"] =
				{
				["ENGLISH"] =
		...
		["EXTRA"] = -- Partygoer
			...
			["EMOTES"] =
				...
				["GERMAN"] = {"/cheer","/dance","/clap"};
				["RUSSIAN"] = {"/cheer","/dance","/clap"};
				};
			["QUICKSLOTS"] =
				{
				["ENGLISH"] =
		...
		["PROTAGONIST"] = -- Bilbo
			...
			["EMOTES"] =
				...
				["FRENCH"] = {"/révérence","/discuter","/discuter"};
				["GERMAN"] = {"/bow","/talk","/wave"};
				["RUSSIAN"] = {"/bow","/talk","/wave"};
				};
			["QUICKSLOTS"] =
				{
				["ENGLISH"] =
		...
		["STUFFINGSTUFFED"] =
			...
			["STRING"] =
				...
				["RUSSIAN"] = "Gather ingredients for the feast\n\nCollect Fresh winterberries - near cabin 12.7N, 93.4W\ncollect eggs from pampered chickens - Cluckland 13.3N, 94.6W\ncollect pampered mushrooms - in greenhouse 11.8N, 94.3W\nmake fresh bread at the servants oven - 12.4N, 95.6W\n\nCo-ordinates from casualstrolltomordor.com";
				};
			};
		...
		["EMPTYKEG"] =
			...
			["STRING"] =
				...
				["RUSSIAN"] = "Deliver a keg to the Thirsty Patron without a Watcher seeing you.\n\nKegs can be found next to the servants oven.\n\nWith the keg, take the path opposite Nora Lewison towards Jack Mitford (third table in the 'Biggest Stomach of Them All' quest - <rgb=#FF0000>be careful as you approach as a Watcher patrols this corner</rgb>).\n\nAt Jack Mitford jump over the wall behind the table to deliver the keg to the Thirsy Patron below.";
				};
			};
		...
		["BIGGESTSTOMACH"] =
			...
			["STRING"] =
				...
				["RUSSIAN"] = "This is an eating race where you need to eat 5 things at each table before you can continue. Try to avoid eating bread and pies as they have the biggest debuffs.\n\n- Berries: -1% run speed (4m)\n- Mushrooms: -3% run speed (4m)\n- Eggs: -5% run speed (4m)\n- Pie: -10% run speed (4m)\n- Bread: -15% run speed (4m)\n- Mystery Drink: Removes all debuffs OR -60% run speed (20s)";
				};
			};
	...
	[5] =
		...
		["MIGHTIESTBLOW_BASIC"] =
			...
			["STRING"] =
				...
				["RUSSIAN"] = "This takes place in the Festival Arena at Thorin's Hall\n\nObjectives:\n-Knock <rgb=#FF0000>8</rgb> competitors out of the way.\n-You do not need to pick up the mug.\n-You will not fail if knocked out of the arena.\n\nContributes to the 'Mightiest Arm' deed.";
				};
		...
		["BREEFIREWORKS"] =
			...
			["STRING"] =
				...
				["RUSSIAN"] = "Follow the instructions given by the 'Fireworks Announcer' to make sure you launch a suitable coloured firework.\n\nThe Announcer will try and trick you out with statements such as, <rgb=#FF0000>anything except</rgb>, or <rgb=#FF0000>anything but</rgb>, so make sure you read the instructions carefully.";
				};
			};
		...
		["LOSTINVITES"] =
			...
			["STRING"] =
				...
				["RUSSIAN"] = "Envelopes can be found around Bree, open them to collect invitations and occassionally get prizes.\n\nNote: You can collect as many envelopes as you want, but can only open them until the six invitations have been collected.";
				};
			};
